...
module ctrl_unit_ipa
  #(
   ...
   logic [NB_CORES-1:0]			           s_trans_alloc_req;
   logic [NB_CORES-1:0] 		           s_trans_alloc_gnt;
   logic [NB_CORES-1:0][TRANS_SID_WIDTH-1:0] 	   s_trans_alloc_ret;
   logic [NB_CORES-1:0][NB_TRANSFERS-1:0] 	   s_trans_alloc_clr;
   logic [NB_CORES-1:0][NB_TRANSFERS-1:0]          s_trans_alloc_status;
   
   logic [NB_CORES-1:0]                            s_core_req;
   logic [NB_CORES-1:0]                            s_core_gnt;
   logic [NB_CORES-1:0][MCHAN_LEN_WIDTH-1:0] 	   s_core_len;
   logic [NB_CORES-1:0][MCHAN_OPC_WIDTH-1:0] 	   s_core_opc;
   logic [NB_CORES-1:0] 			   s_core_inc;
   logic [NB_CORES-1:0] 			   s_core_twd;
   logic [NB_CORES-1:0] 			   s_core_ele;
   logic [NB_CORES-1:0] 			   s_core_ile;
   logic [NB_CORES-1:0] 			   s_core_ble;
   logic [NB_CORES-1:0][TWD_QUEUE_ADD_WIDTH-1:0]   s_core_twd_add;
   logic [NB_CORES-1:0][TRANS_SID_WIDTH-1:0] 	   s_core_sid;
   logic [NB_CORES-1:0][TCDM_ADD_WIDTH-1:0] 	   s_core_tcdm_add;
   logic [NB_CORES-1:0][EXT_ADD_WIDTH-1:0] 	   s_core_ext_add;
   
   logic [NB_CORES-1:0]                            s_cores_busy;
   
   logic [NB_CORES-1:0] 			   s_twd_alloc_req;
   logic [NB_CORES-1:0] 			   s_twd_alloc_gnt;
   logic [NB_CORES-1:0][TWD_QUEUE_ADD_WIDTH-1:0]   s_twd_alloc_add;
   
   logic [NB_CORES-1:0]				   s_twd_queue_req;
   logic [NB_CORES-1:0][TWD_QUEUE_ADD_WIDTH-1:0]   s_twd_queue_add;
   logic [NB_CORES-1:0][TWD_QUEUE_WIDTH-1:0]       s_twd_queue_dat;
   logic [NB_CORES-1:0][TRANS_SID_WIDTH-1:0]       s_twd_queue_sid;
      ...
      for (i=0; i<NB_CORES; i++)
        begin : core_if_bind
	       ...
	       .TWD_QUEUE_DEPTH        ( TWD_QUEUE_DEPTH        ),
               .TRANS_ARBITER_WIDTH    ( TRANS_ARBITER_WIDTH    ),
